...
import {
  Stok, Plus, Trash2, Image as ImageIcon, Camera, Pindai, Layers,
  Opname, Save, StokRiwayat, Supplier, InOut, ArrowUpCircle, ArrowDownCircle, CategoryIcon
} from './welp-icons.jsx';
          ...
          <div className="card !rounded-3xl overflow-hidden">
            <div className="bg-chrome-deep px-5 py-5 relative overflow-hidden">
              <div className="flex items-center gap-2 mb-1 opacity-80">
                <Layers className="w-4 h-4 text-apricot" />
            ...
            <div className="p-5 space-y-4">
              <div className="flex justify-center py-1">
                <div className="w-24 h-24 bg-paper dark:bg-white/[.03] rounded-2xl flex items-center justify-center relative overflow-hidden border-2 border-dashed border-line dark:border-line-dark group hover:border-flame-400 transition cursor-pointer">
                  {newProd.image ? <img src={newProd.image} className="w-full h-full object-cover" /> : <div className="text-center text-ink-faint/60"><ImageIcon className="w-7 h-7 mx-auto" /><span className="text-[9px] font-extrabold">Upload Foto</span></div>}
    ...
    <div className="max-w-3xl mx-auto w-full pb-24">
      ...
      <Card title="Form Pergerakan Stok" icon={InOut}>
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            {[
              { id: 'Masuk', icon: ArrowDownCircle, cls: 'bg-leaf-soft dark:bg-leaf/15 border-leaf/40 text-leaf-deep dark:text-leaf' },
              { id: 'Keluar', icon: ArrowUpCircle, cls: 'bg-brick-soft dark:bg-brick/10 border-brick/40 text-brick-deep dark:text-brick' }
            ].map(o => (
